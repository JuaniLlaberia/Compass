  ...
  return createPortal(
    <>
      <motion.div
        ...
        className='bg-light-bg-1 text-light-text-1 fixed top-[40%] left-[50%] translate-x-[-50%] translate-y-[-40%] w-[50vw] min-w-[325px] max-w-[650px] p-3 rounded-lg min-h-[100px] z-[110] shadow-md'
      >
        <button
