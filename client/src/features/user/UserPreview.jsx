  ...
  return (
    <>
      <div className='flex flex-col items-center'>
        <UserCardHeader userInfo={userData} categories={userData?.category} />
        <div className='max-w-[18rem] 2xl:max-w-[25rem] w-full gap-2 mt-5 p-2 px-3 border border-light-border-1 dark:border-dark-border-1 rounded-xl shadow-md'>
