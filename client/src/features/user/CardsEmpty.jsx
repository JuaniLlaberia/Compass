...
const CardsEmpty = () => {
  return (
    <section className='flex flex-col items-center justify-center px-5 h-full'>
      <h1 className='flex items-center gap-2 font-semibold text-light-text-1 dark:text-dark-text-1 mb-3 lg:text-xl'>
        <span className='text-secondary-1'>
          <IoSearchSharp size={25} />{' '}
        </span>
        You have seen them all
      </h1>
      <p className='text-sm text-light-text-2 dark:text-dark-text-2 mb-8 lg:text-base'>
